...
const Home = ( {navigation} ) => {
  ...
  function onSelectCategory(category) {
    ...
    // filtrelenmiş restoranları state'e aktar
    ...
    const renderItem = ({item}) => {
      return (
        <TouchableOpacity
          ...
          {/* içindeki beyaz yuvarlak kısmın stillendirmesi */}
          <View
            style={{
              width: 50,
              height: 50,
  ...
  function renderRestaurantList() {
    const renderItem = ({item}) => (
      <TouchableOpacity
        ...
        // item ve currentLocation'u da gönder
      ...
      >
        ...
        <View
          ...
          {/* zamanı belirten sol alttaki beyaz kısım */}
          <View
            style={{
              position: 'absolute',
              bottom: 0,
